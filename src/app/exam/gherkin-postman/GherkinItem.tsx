...
const GherkinItem: React.FC<GherkinItemProps> = ({
    id,
    gherkin,
    onClick,
    onDoubleClick,
    ...
    const [gherkinContent, setGherkinContent] = useState<string>(gherkin);
    ...
    const handleDoubleClick = () => {
      ...
      onDoubleClick({ id, gherkin });
    };
  
    return (
         <div
            className={`mb-4 p-4 bg-white border ${
                isSelected ? "border-orange-500" : "border-gray-300"
            } rounded-lg cursor-pointer ${
                editingId === id ? "h-full" : "h-96"
            ...
            {editingId === id && (
              <div className="flex justify-end space-x-2 mt-2">
                <button
                  ...
                  onClick={() => onSave(id, gherkinContent)}
                >
                  Save
                </button>
                <button
