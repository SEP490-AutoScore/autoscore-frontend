...
import { CreateExamPaperDialog } from "@/app/exam/exam-paper-overview/create-unused-exam-paper-form";
  ...
  return (
    <div className="w-full border border-gray-200 p-8 rounded-lg">
      <div className="flex items-center justify-between space-y-2">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">Exam Papers</h2>
