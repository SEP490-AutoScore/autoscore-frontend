...
const UpdateExamDialog: React.FC<UpdateExamDialogProps> = ({ examId, onUpdateSuccess }) => {
    ...
    useEffect(() => {
        const fetchExam = async () => {
            try {
                const response = await fetch(`${BASE_URL}${API_ENDPOINTS.createExam}${examId}`, {
                    headers: {
                ...
                const errorMessage = (err as Error).message || "Error fetching exam data.";
        ...
        const fetchSemesters = async () => {
            try {
                ...
                const errorMessage = (err as Error).message || "Error fetching semesters.";
                setError(errorMessage);
                showToast({
                    title: "Error",
                    description: errorMessage,
        ...
        const fetchSubjects = async () => {
            try {
                ...
                const errorMessage = (err as Error).message || "Error fetching subjects.";
                setError(errorMessage);
                showToast({
                    title: "Error",
                    description: errorMessage,
                        ...
                        >
                            ...
                            <div>
                                ...
                                <Input
                                    ...
                                    value={exam.examAt}
                                    onChange={(e) =>
                                        setExam({ ...exam, examAt: e.target.value })
                                    }
                                    required
                            ...
                            <div>
                                ...
                                <div className="relative w-full">
                                    <Input
                                        ...
                                        onChange={(e) => setExam({ ...exam, gradingAt: e.target.value })}
                                        required
                                        className="mt-1 block w-full p-2 border border-gray-300 rounded"
                                    />
                                </div>
