        ...
        <Table>
          ...
          <TableBody>
            {[...Array(6)].map((_, rowIndex) => (
              <TableRow key={rowIndex} className="grid grid-cols-6">
                {[...Array(4)].map((_, cellIndex) => (
                  <TableCell key={cellIndex} className={`
                    px-4 py-2
                    ${cellIndex === 2 ? "col-span-3" : "col-span-1"} 
                  `}>
                    <div className={`h-4 bg-muted w-2/3 rounded-md animate-pulse ${cellIndex === 3 ? "w-12 h-6" : ""}`}></div>
                  </TableCell>
                ))}
              </TableRow>
            ))}
